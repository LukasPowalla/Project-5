...
//-------------------------------------------------------------------
          if(0 == k%100){
            kinPotEnergy();
            for (int i = 0; i < (planets.size()*2+3); i++){
...
void solarsystem::RungeKuttamethod(double dt,int n){
    ...
    for(int i=0;i<n;i++){
        ...
        //--------------------------------------------------------
         if(0 == i%100){
           kinPotEnergy2();
           for (int k = 0; k < (planets.size()*2+3); k++){
...
void solarsystem::kinPotEnergy(){
    ...
    for (int i = 0; i < n;i++){
        ...
        kinetic = 0.5*planets[i].m*sqrt (kinetic);
    ...
    Mat<double> p = Mat<double>(n,n,fill::zeros);
